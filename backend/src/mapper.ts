...
export interface Schema {
  ...
  visual_analysis: {
    ...
    focal_points: Array<{ x: number; y: number; confidence: number }>;
    segmentation: Array<{ region: string; confidence: number; bounds: [number, number, number, number] }>;
  };
}
...
function parseVisualAnalysis(analysis: any): Schema {
...
function extractPrimaryElements(analysis: any): string[] {
...
function extractSecondaryElements(analysis: any): string[] {
  const elements: string[] = [];
...
function extractSceneInfo(analysis: any): Schema['scene'] {
  return {
...
function extractCompositionInfo(analysis: any): Schema['composition'] {
  return {
...
function extractVisualAnalysis(analysis: any): Schema['visual_analysis'] {
  return {
...
function generateEnhancedMockSchema(imagePath: string): Schema {
...
export function validateSchema(schema: Schema): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
