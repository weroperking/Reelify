...
export const dynamic_composition: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <Img
          src={`http://localhost:3001/temp/temp-image-1766180570026-ugdwb2n0u`}
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover',
          ...
          onError={(e) => {
            console.error('Failed to load image:', 'temp-image-1766180570026-ugdwb2n0u');
            e.currentTarget.style.display = 'none';
          }}
          onLoad={() => {
            console.log('Image loaded successfully:', 'temp-image-1766180570026-ugdwb2n0u');
          }}
        />
