...
export const dynamic_composition: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <Img
          src={`./temp-image-1766180255812-usqxmgjxb`}
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover',
          ...
          onError={(e) => {
            console.error('Failed to load image:', 'temp-image-1766180255812-usqxmgjxb');
            e.currentTarget.style.display = 'none';
          }}
          onLoad={() => {
            console.log('Image loaded successfully:', 'temp-image-1766180255812-usqxmgjxb');
          }}
        />
